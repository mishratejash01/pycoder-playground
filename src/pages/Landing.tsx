  ...
  return (
    <div className="min-h-screen bg-white selection:bg-primary/20 flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 w-full">
        ...
        {/* --- MAIN CONTENT START --- */}
        <div id="main-content" className="bg-[#09090b]">

          {/* --- SECTION 1: TECHNICAL LAPTOP & TEXT --- */}
          <section className="py-24 relative overflow-hidden border-b border-white/5">
            ...
            <div className="container mx-auto px-6 relative z-10">
              <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                {/* LEFT: Technical Text & Button */}
                <div className="flex-1 space-y-10 text-center lg:text-left">
                  <div className="space-y-4">
                    <h2 className="text-4xl md:text-6xl font-bold tracking-tighter text-white leading-tight font-neuropol drop-shadow-xl">
                      LEVEL UP <br/> YOUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">CODE GAME</span>
                    </h2>
                    
                    <p className="text-muted-foreground text-lg md:text-xl max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
                      Stop watching tutorials. Start solving real problems. <br className="hidden md:block"/>
                      Compete, debug, and build your career in a pro environment.
                    </p>
                  </div>

                  <div className="flex flex-col items-center lg:items-start gap-8">
                    {/* BUTTON: Round Rectangular */}
                    <Button 
                    ...
                    <div className="w-full max-w-md overflow-hidden relative mask-gradient-x">
                      ...
                      <div className="bg-[#09090b] rounded-t-md border border-white/5 overflow-hidden aspect-[16/10] relative group">
                        ...
                        <div className="absolute inset-0 flex flex-col font-mono text-[9px] md:text-[10px] text-gray-400">
                          ...
                          <div className="h-6 border-b border-white/10 flex items-center px-3 justify-between bg-[#0c0c0e]">
                            ...
                            <div className="text-xs text-white/40">main.py - Codevo Editor</div>
          ...
          {/* --- SECTION 2: KEYBOARD & TERMINAL INTERACTION --- */}
